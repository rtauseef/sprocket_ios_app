...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "HPPhotoProvider/Pod/Assets/Check.png"
  install_resource "HPPhotoProvider/Pod/Assets/Check@2x.png"
  install_resource "HPPhotoProvider/Pod/Assets/Check@3x.png"
  install_resource "HPPhotoProvider/Pod/Assets/Check_Inactive1.png"
  install_resource "HPPhotoProvider/Pod/Assets/Check_Inactive1@2x.png"
  install_resource "HPPhotoProvider/Pod/Assets/Check_Inactive1@3x.png"
  ...
  install_resource "HPPhotoProvider/Pod/TencentOpenApi_IOS_Bundle.bundle"
  ...
  install_resource "MobilePrintSDK/Pod/Classes/Private/Manta/MPBTProgressView.xib"
