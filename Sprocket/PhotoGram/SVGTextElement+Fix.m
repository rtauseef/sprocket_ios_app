...
#import "SVGTextElement+Fix.h"
#import "UIColor+HexString.h"
#import "SVGHelperUtilities.h"
#import <CoreText/CoreText.h>

@implementation SVGTextElement (Fix)
...
- (CALayer *) newLayer
{
	...
	actualFamily = [actualFamily stringByReplacingOccurrencesOfString:@"'" withString:@""];
	NSString* color = [self cascadedValueForStylableProperty:@"fill"];
    ...
    label.foregroundColor = [UIColor colorWithHexString:color].CGColor;
