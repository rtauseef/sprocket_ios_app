...
- (NSArray *)standardUSFrames
{
    return @[
             ...
             [[PGFrameItem alloc] initWithName:@"L'Oreal" imageName:@"LOreal_iOS_1c" andPackageName:nil],
             [[PGFrameItem alloc] initWithName:@"Nestle" imageName:@"Nestle_iOS_Frame" andPackageName:nil],
             [[PGFrameItem alloc] initWithName:@"San Pelegrino" imageName:@"S_pellegrino_iOS_Frame" andPackageName:nil],
