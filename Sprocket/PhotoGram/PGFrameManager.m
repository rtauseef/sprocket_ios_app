...
- (NSArray *)standardUSFrames
{
    return @[
             ...
             [[PGFrameItem alloc] initWithName:@"L'Oreal Android" imageName:@"LOreal_Android_1c" andPackageName:nil],
             [[PGFrameItem alloc] initWithName:@"L'Oreal iOS" imageName:@"LOreal_iOS_1c" andPackageName:nil],
             [[PGFrameItem alloc] initWithName:@"Nestle Android" imageName:@"Nestle_Android" andPackageName:nil],
             ...
             [[PGFrameItem alloc] initWithName:@"San Pelegrino Android" imageName:@"SanPellegrino_Android" andPackageName:nil],
             [[PGFrameItem alloc] initWithName:@"ChainSmokers Android 1" imageName:@"ChainSmokers_Android_1" andPackageName:nil],
             [[PGFrameItem alloc] initWithName:@"ChainSmokers Android 2" imageName:@"ChainSmokers_Android_2" andPackageName:nil],
