...
+ (void)maskImageWithURL:(NSString *)url diameter:(float)diameter borderWidth:(float)borderWidth completion:(void (^)(UIImage *))completion
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^ {
        ...
        UIImage *resizedImage = [image imageResize:CGSizeMake(diameter, diameter)];
