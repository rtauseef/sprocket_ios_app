...
- (NSArray<IMGLYSticker *> *)foodCategoryStickers {
    return @[
             ...
             [[PGStickerItem alloc] initWithName:@"Taco 2" imageName:@"taco2" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Watermelon" imageName:@"watermelon" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Pineapple" imageName:@"Pineapple" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Bacon n egg" imageName:@"bacon_egg" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Soda Can" imageName:@"Soda_can" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Ice Cream Cone" imageName:@"icecreamcone" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Candy" imageName:@"candy" andPackageName:nil].imglySticker,
             ...
             [[PGStickerItem alloc] initWithName:@"Valentines Cupcake" imageName:@"v_cupcake" andPackageName:nil].imglySticker,
             ...
             [[PGStickerItem alloc] initWithName:@"Ketchup Hot Dog" imageName:@"ketchup-hotdog" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Apple Angry" imageName:@"apple_angry" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Spoon" imageName:@"spoon" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Fork" imageName:@"fork" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Soda" imageName:@"soda" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Turkey" imageName:@"Turkey-leg" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Cocoa" imageName:@"Cocoa" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Oranges" imageName:@"oranges" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Pie" imageName:@"Pie" andPackageName:nil].imglySticker,
             ];
}
...
- (NSArray<IMGLYSticker *> *)birthdayCategoryStickers {
    return @[
             ...
             [[PGStickerItem alloc] initWithName:@"Balloons" imageName:@"balloons" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Cat Celebrate" imageName:@"cat-celebrate" andPackageName:nil].imglySticker,
             ];
}

- (NSArray<IMGLYSticker *> *)animalCategoryStickers {
    return @[
             [[PGStickerItem alloc] initWithName:@"Cat Face" imageName:@"cat_face" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Cat" imageName:@"cat_body" andPackageName:nil].imglySticker,
...
//             [[PGStickerItem alloc] initWithName:@"Cat Glasses" imageName:@"catglasses" andPackageName:nil].imglySticker,
             ...
             [[PGStickerItem alloc] initWithName:@"Cat Grumble" imageName:@"cat_grumble" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Cat Fries" imageName:@"cat-fries" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Spider" imageName:@"spider" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Bird Envelope" imageName:@"bird_envelope" andPackageName:nil].imglySticker,
...
//             [[PGStickerItem alloc] initWithName:@"Flowers" imageName:@"flowers" andPackageName:nil].imglySticker,
             ...
             [[PGStickerItem alloc] initWithName:@"Stars" imageName:@"stars" andPackageName:nil].imglySticker,
             [[PGStickerItem alloc] initWithName:@"Star Yellow" imageName:@"star_yellow" andPackageName:nil].imglySticker,
             ...
             [[PGStickerItem alloc] initWithName:@"Cloud Sun" imageName:@"cloud-sun" andPackageName:nil].imglySticker,
