...
- (NSArray *)standardUSMagicFrames
{
    return @[
             ...
             [[PGFrameItem alloc] initWithName:@"BIRTHDAY Monkeys" imageName:@"BIRTHDAY_Monkeys" andPackageName:nil],
             ...
             [[PGFrameItem alloc] initWithName:@"SUMMER Amazon 2" imageName:@"SUMMER_Amazon_2" andPackageName:nil],
             [[PGFrameItem alloc] initWithName:@"SUMMER Island" imageName:@"SUMMER_Island" andPackageName:nil],
