...
/// A <code>BoxedMenuItem</code> wraps a <code>MenuItem</code> so that it can be used from Objective-C. Please see the
...
+ (NSArray<IMGLYBoxedMenuItem *> * _Nonnull)boxedDefaultItemsWithConfiguration:(IMGLYConfiguration * _Nonnull)configuration SWIFT_WARN_UNUSED_RESULT;
@end
...
/// A <code>BoxedPhotoEditModel</code> holds information about any modification that should be applied to an image.
...
/// The <code>IMGLYFocusType</code> to apply to the image.
...
+ (enum IMGLYOrientation)identityOrientation SWIFT_WARN_UNUSED_RESULT;
...
- (enum IMGLYOrientation)canvasViewAppliedOrientation:(IMGLYCanvasView * _Nonnull)canvasView SWIFT_WARN_UNUSED_RESULT;
...
- (UIEdgeInsets)canvasViewImageInsets:(IMGLYCanvasView * _Nonnull)canvasView SWIFT_WARN_UNUSED_RESULT;
...
- (CGSize)canvasViewOutputImageSize:(IMGLYCanvasView * _Nonnull)canvasView SWIFT_WARN_UNUSED_RESULT;
@end
...
/// returns:
/// The resulting asset.
- (UIImage * _Nullable)buildWithSize:(CGSize)size relativeScale:(CGFloat)relativeScale SWIFT_WARN_UNUSED_RESULT;
@end
...
+ (IMGLYCustomPatchFrameBuilder * _Nonnull)art1FrameBuilder SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
+ (IMGLYDefaultProgressView * _Nonnull)sharedView SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// This array contains all availanle fonts. It can be set via the <code>Configuration</code> class.
...
+ (NSArray<IMGLYFont *> * _Nonnull)fonts SWIFT_WARN_UNUSED_RESULT;
...
/// paint it onto the <code>UIImage</code>. The pieces are cropped at the insides to match the
...
/// for the composition is pushed together along the x or y axis, depending on the ratio of,
/// the given size.
/// \param size Size of the targed <code>UIImage</code>.
///
/// \param relativeScale not implemented yet.
///
///
/// returns:
/// Returns an <code>UIImage</code> containing the composed frame asset.
- (UIImage * _Nullable)buildWithSize:(CGSize)size relativeScale:(CGFloat)relativeScale SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
- (NSURL * _Nullable)imageURLForRatio:(CGFloat)ratio withTolerance:(CGFloat)tolerance SWIFT_WARN_UNUSED_RESULT;
...
- (UIImage * _Nullable)imageForSize:(CGSize)size SWIFT_WARN_UNUSED_RESULT;
...
- (NSURL * _Nullable)thumbnailURLForRatio:(CGFloat)ratio withTolerance:(CGFloat)tolerance SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)hasImageForRatio:(CGFloat)ratio withTolerance:(CGFloat)tolerance SWIFT_WARN_UNUSED_RESULT;
/// Creates the default frames that are shipped with the SDK.
///
/// returns:
/// An array of frames.
+ (NSArray<IMGLYFrame *> * _Nonnull)createDefaultFrames SWIFT_WARN_UNUSED_RESULT;
@end
...
/// <code>LUTConverter</code> creates the color cube data needed for a <code>CIColorCube</code> filter by reading the
...
/// Creates a newly allocated instance of <code>LUTConverter</code> with an identity LUT at the given URL.
/// \param identityLUT The url to the identity LUT.
///
///
/// returns:
/// An instance of <code>LUTConverter</code>.
...
+ (NSData * _Nullable)colorCubeDataFromLUTAtURL:(NSURL * _Nonnull)lutURL SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
+ (IMGLYOverlayButton * _Nonnull)makeAddButton SWIFT_WARN_UNUSED_RESULT;
/// Creates the default delete button.
///
/// returns:
/// The default delete button.
+ (IMGLYOverlayButton * _Nonnull)makeDeleteButton SWIFT_WARN_UNUSED_RESULT;
/// Creates the default flip button.
///
/// returns:
/// The default flip button.
+ (IMGLYOverlayButton * _Nonnull)makeFlipButton SWIFT_WARN_UNUSED_RESULT;
/// Creates the default straighten button.
///
/// returns:
/// The default straighten button.
+ (IMGLYOverlayButton * _Nonnull)makeStraightenButton SWIFT_WARN_UNUSED_RESULT;
/// Creates the default bring to front button.
///
/// returns:
/// The default bring to front button.
+ (IMGLYOverlayButton * _Nonnull)makeToFrontButton SWIFT_WARN_UNUSED_RESULT;
/// Creates the default undo button.
///
/// returns:
/// The default undo button.
+ (IMGLYOverlayButton * _Nonnull)makeUndoButton SWIFT_WARN_UNUSED_RESULT;
/// Creates the default redo button.
///
/// returns:
/// The default redo button.
+ (IMGLYOverlayButton * _Nonnull)makeRedoButton SWIFT_WARN_UNUSED_RESULT;
/// Creates the default alignment button.
///
/// returns:
/// The default alignment button.
+ (IMGLYOverlayButton * _Nonnull)makeAlignmentButton SWIFT_WARN_UNUSED_RESULT;
@end
...
/// An <code>OverlayController</code> manages all overlays that have been added to an image and hosts the
...
/// An <code>UIImage</code> of the painting to use as an overlay.
...
+ (PESDK * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
...
/// If this block is <code>nil</code>, the imglyKit.bundle + localizationDict will be used.
...
/// If this block is <code>nil</code>, the image from the imglyKit.bundle will be used.
...
- (CIImage * _Nullable)photoEditToolControllerBaseCIImage:(IMGLYPhotoEditToolController * _Nonnull)photoEditToolController SWIFT_WARN_UNUSED_RESULT;
...
- (IMGLYOverlayController * _Nullable)photoEditToolControllerOverlayController:(IMGLYPhotoEditToolController * _Nonnull)photoEditToolController SWIFT_WARN_UNUSED_RESULT;
@end
...
+ (NSArray<IMGLYStickerCategory *> * _Nonnull)createDefaultStickerCategories SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
/// Options for configuring a <code>StickerColorToolController</code>.
...
/// Creates a newly allocated instance of <code>StickerColorToolControllerOptions</code> using the default builder.
- (nonnull instancetype)init;
/// Creates a newly allocated instance of <code>StickerColorToolControllerOptions</code> using the given builder.
/// \param builder A <code>StickerColorToolControllerOptions</code> instance.
///
...
/// The default <code>StickerColorToolControllerOptionsBuilder</code> for <code>StickerColorToolControllerOptions</code>.
...
/// Defaults to <code>1:1</code>, <code>4:3</code> and <code>16:9</code>.
